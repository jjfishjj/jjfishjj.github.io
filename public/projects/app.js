...
const projects = [
  ...
  },
  {
    ...
    description: "把履歷轉成可互動的 3D 展示頁，連接專業經歷、遊戲化作品集與視覺化自我介紹。",
    tags: ["3D Resume", "Portfolio", "Interactive", "Web"],
    demo: "/resume-3d/",
    repo: "https://github.com/jjfishjj/jjfishjj.github.io",
  },
  {
  ...
  },
  {
    ...
    description: "以 Gamania / Prasia 類遊戲營運、AI workflow 與 LearningOps 為情境，展示 KPI、漏斗、RFM 分群、熱度圖與決策摘要。",
    tags: ["Gamania", "Prasia", "RFM", "AI Workflow"],
